...
import com.wordnik.client.model.Body_1
import java.io.File
...
class PetApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val addPetOperation = (apiOperation[Unit]("addPet")
    ...
    parameters (bodyParam[Body_1]("body").description("")))

  post("/pet", operation(addPetOperation)) {

    val body = parsedBody.extract[Body_1]
  ...
  val findPetsByStatusOperation = (apiOperation[List[Inline_response_200]]("findPetsByStatus")
  ...
  get("/pet/findByStatus", operation(findPetsByStatusOperation)) {
    ...
    val status = if ("multi" == "default" || "multi" == "csv") {
      statusString match {
  ...
  val findPetsByTagsOperation = (apiOperation[List[Inline_response_200]]("findPetsByTags")
  ...
  get("/pet/findByTags", operation(findPetsByTagsOperation)) {
    ...
    val tags = if ("multi" == "default" || "multi" == "csv") {
      tagsString match {
        case Some(str) => str.split(",").toSeq
        case None      => Seq()
      }
  ...
  val getPetByIdOperation = (apiOperation[Inline_response_200_1]("getPetById")
  ...
  val updatePetOperation = (apiOperation[Unit]("updatePet")
    ...
    parameters (bodyParam[Body]("body").description("")))
  ...
  val uploadFileOperation = (apiOperation[Inline_response_200_2]("uploadFile")
