...
import com.wordnik.client.model.Body_3
import com.wordnik.client.model.Body_4
import com.wordnik.client.model.Body_5
...
class UserApi (implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val createUserOperation = (apiOperation[Unit]("createUser")
      summary "Create user"
      parameters(bodyParam[Body_3]("body").description(""))
  )

  post("/user",operation(createUserOperation)) {
    
    
          val body = parsedBody.extract[Body_3]
  ...
  val createUsersWithArrayInputOperation = (apiOperation[Unit]("createUsersWithArrayInput")
      ...
      parameters(bodyParam[List[Body_4]]("body").description(""))
  )

  post("/user/createWithArray",operation(createUsersWithArrayInputOperation)) {
    
    
          val body = parsedBody.extract[List[Body_4]]
  ...
  val getUserByNameOperation = (apiOperation[Body_4]("getUserByName")
  ...
  val updateUserOperation = (apiOperation[Unit]("updateUser")
      ...
      parameters(pathParam[String]("username").description(""), bodyParam[Body_5]("body").description(""))
  )
  ...
  put("/user/:username",operation(updateUserOperation)) {
    ...
    println("username: " + username)
          ...
          val body = parsedBody.extract[Body_5]
